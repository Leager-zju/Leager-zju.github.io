...
slug: "interviewexperience"
url: "/notes/interviewexperience/"
draft: false
math: true
categories:
  - "interview"
...
> 具体可参考 [C++ の OOP](/notes/c-oop/#与-struct-的异同)
...
> 具体可参考 [C++11 の 智能指针](/notes/c-smartptr/)
...
> 具体可参考 [C++ の static](/notes/c-static/)
...
> 具体可参考 [C++11 の 内存分配](/notes/c-memory/)
...
> 具体可参考 [条款 9. 绝不在构造和析构过程中调用 virtual 函数](/notes/effectivec-note/#绝不在构造和析构过程中调用-virtual-函数)
...
> 具体可参考 [C++11 の 面向对象](/notes/c-oop/#虚继承-1)

在虚函数表的负值索引处，除了 `runtime typeinfo`，其实还会存虚继承的虚基类 `offset`。

### 简单介绍智能指针

> 具体可参考 [C++ の 智能指针](/notes/c-smartptr/)

### 如何实现一个支持引用计数的类？

> 具体可参考 [如何手撕智能指针](/notes/c-smartptr/#如何手撕一个-shared-ptr)
...
> 具体可参考 [并发应用 —— 线程池](/notes/c-concurrent/#%E7%BA%BF%E7%A8%8B%E6%B1%A0thread-pool)
...
> 具体可参考 [点击 Url 到显示网页之间发生了什么？](/notes/whathappenedafterclickurl/)
...
> 具体可参考 [TCP Things](/notes/tcpthings/#为什么握手是三次而不是两次四次)，其实还有一些其他的作用。
...
> 具体可参考 [TCP Things](/notes/tcpthings/#为什么-time-wait-要等-2msl)。
