$(function() {
  ...
  /*初始化瀑布流布局*/
  $('#articles').masonry({itemSelector: '.article'});

  AOS.init({easing: 'ease-in-out-sine', duration: 700, delay: 100});
  ...
  let articleInit = function() {
    ...
    $('#articleContent img').each(function() {
      ...
      $(this).wrap(
          '<div class="img-item" data-src="' + imgPath +
...
document.addEventListener('DOMContentLoaded', function() {
  const anchors = document.querySelectorAll('a.header-anchor[href^="#"]');
  ...
  anchors.forEach(anchor => {
    anchor.addEventListener('click', function(e) {
      ...
      const targetElement = document.querySelector('a.header-anchor[href="' + targetId + '"]');
